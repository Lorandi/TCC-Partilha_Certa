...
- [ ] Confirmar nome do autor e orientador(a).
  - **Arquivos:** `01-planejamento/TCC.md`, futuro `05-artigo-latex/main.tex`
  - **Critério de conclusão:** identificação preenchida.
...
- [ ] Documentar entidades e regras de negócio do domínio sucessório.
  - **Arquivo:** `06-sistema/requisitos/modelagem-dominio.md`
  - **Critério de conclusão:** entidades, atributos, relações e regras principais descritas.

- [ ] Planejar cenários simulados de validação.
  - **Arquivo:** `06-sistema/testes-validacao/cenarios-validacao.md`
  - **Critério de conclusão:** cenários com dados de entrada, resultado esperado e critério de comparação.

## Depois

- [ ] Preparar template LaTeX oficial em `05-artigo-latex/`.
...
- [ ] Revisar o artigo antes da entrega.
  ...
  - **Critério de conclusão:** pendências críticas resolvidas ou registradas.
